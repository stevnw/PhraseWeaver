...
def generate_german_audio(csv_file_path="food.csv", output_folder="audio"): # Change the name each time hahahahahahahahaha 
    ...
    try:
        ...
        for i, row in enumerate(updated_rows):
            ...
            try:
                ...
                tts = gTTS(text=german_text, lang='es', slow=False)
